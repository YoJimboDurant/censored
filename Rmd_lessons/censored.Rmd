...
ggplot(dfz, aes(x=`Dollar Contribution`, y=`Contrib`/10, color = Censored)) + geom_step(size=1.25) + 
  ...
  scale_color_manual("Model", values = c("#0072B2", "#F0E442")) + 
...
```
- The survival probabilities have decreased for levels below the censoring level.
- The change in X ($Delta$) is 2 between 3 and 5.

...
Assuming Charles gives us an answer of, " I will give you no more than 3 dollars!" If we assume that Charles would give any amount between 0 and 3 with equal probabilty, we could assign that extra (1/4) probability to the observations below 3. 
...
# scales (adds) up the probabilities by 1/3 (one observation spread across 3 points) lowers S(x) by 1/3!

#e.g. 1/10 becomes 1 * (1+1/3) / 10
#      2/10 becomes 2 * (1+1/3)/10
```
## ECDF and KM

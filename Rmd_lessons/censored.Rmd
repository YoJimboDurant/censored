...
## PDF's Predict Percent of Observations > Given Value 
...
The mean value of a distribution is equal to the sum of x time x's frequency of observation. Since the PDF is approaches zero for any single value, we have to use calculus to represent this:
